...
This table is showing that 69.57% of the unvaccinated male group experienced symptoms while only 30.43% of the vaccinated males experienced symptoms. It is aslo telling us that the male placebo group, 2.55% of them contracted COVID while only 1.15% of the vaccinated group conracted COVID.
...
Based on the Fisher exact test, we got a p-value of 0.0000000000004631 concluding that we are rejecting the null hypothesis. The odds in this fisher test are showing males have a 2.24% chance of 
...
Based on this chisq test, the p-value is 0.0000002842 concluding that the there is an effect between the COVID vaccine and the drug user data, concluding that we are rejecting the null hypothesis.
